...
1) ЭТО ПРОСТО. Настраиваете один раз - используете всегда. Для создания загрузочного образа с любым дистрибутивом нужно выполнить всего одну команду.
...
1) Отключение питания компьютера приведёт к потере всех данных в оперативной памяти. Храните данные в "облаке".
