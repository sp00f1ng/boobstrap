...
# booty build gentoo-stage3-distfiles/ boot.iso
...
# booty build gentoo-stage3-distfiles/ documents-and-settings/ boot.iso
...
# booty build gentoo-stage3-distfiles/ boot.iso --profile initramfs
...
# booty build ДИРЕКТОРИЯ ДИРЕКТОРИЯ ДИРЕКТОРИЯ... ОБРАЗ ПАРАМЕТРЫ
