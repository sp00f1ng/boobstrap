НЕТ ВРЕМЕНИ ОБЪЯСНЯТЬ, КАК ЭТИМ ПОЛЬЗОВАТЬСЯ?
...
* booty создаёт файловую систему, копируя данные пользователя.
* booty создаёт универсальный загрузочный образ с данными.
