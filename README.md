...
Баг архитектурный. Когда система долго работает, размер /var/log может разрастись до больших размеров из-за китайских бонетов, брутфорсящих SSH. Из-за этого на первый взгляд стабильная, работающая система просто зависает.
