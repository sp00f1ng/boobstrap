...
Название происходит от слов **boot** to an**y**where, "загружаться куда угодно". Приложение работает с любым дистрибутивом GNU/Linux. Благодаря строгому соблюдению POSIX shell синтаксиса, приложение легко переносимо на любую архитектуру и любое устройство, и работает везде, где установлен POSIX shell.
...
Система загруженная с помощью booty работает в оперативной памяти, но имеет ряд интересных особенностей.
